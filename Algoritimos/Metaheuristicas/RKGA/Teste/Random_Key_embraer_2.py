...
def random_key_genetic(ambiente, rotacoes, pop_size, n_generations, tabela_nfps,base=None, altura=None):
    print("\nRandom Key Iniciado!")
    # População inicial
    ...
    for generation in range(n_generations):
        ...
        for keys in population:
            ...
            ambiente_temp = CSP(dataset=ambiente.pecas, render=False, plot=False,Base=base,Altura=altura)
            I1 = []
