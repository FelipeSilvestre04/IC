...
def GRASP(mIter, x,q1,q2,q3,rotacoes,pecas_inisol, instancia,tabela_nfps):
    for i in range(mIter):
        ...
        I1_novo = LocSEARCH(I1,I2,x,q1,q2,q3,fecho, 0.4,instancia,tabela_nfps)
...
ins = ['fu','dighe1','dighe2','mao','dagli','jackobs2','jackobs1','albano','marques']
                ...
                #for inter in interpolacoes:
                    ...
                    #for Q1,Q2,Q3 in pesos:
                        #for vin in vizinhancas:   
                            ...
                            with open(filename, "a") as file:
                                file.write("---------------------------------------------------------------------------------------------\n")
                                file.write(f"GRASP ORIGINAL {instancia}: pre processar nfp {round(Etime-Stime,1)}, iteracoes maxima {max_iter}, {vizinhanca} vizinhancas, q1,q2,q2 = {q1},{q2},{q3}, interpolacao = {inter}, fecho = {fecho}, pecas inisol = {env.max_pecas - int(round(len(env.lista)*0.7,0))}/{env.max_pecas}, rotacoes{rotacoes}\n")
                            ...
                            for i in range(5):
                                ...
                                pecas = GRASP(max_iter, vizinhanca, q1, q2, q3, rotacoes,int(round(len(env.lista)*0.7,0)),instancia, tabela_nfps)
