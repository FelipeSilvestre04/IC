                ...
                #for inter in interpolacoes:
                    ...
                    #for Q1,Q2,Q3 in pesos:
                        #for vin in vizinhancas:   
                            ...
                            with open(filename, "a") as file:
                                file.write("---------------------------------------------------------------------------------------------\n")
                                file.write(f"GRASP GCG {instancia}: pre processar nfp {round(Etime-Stime,1)}, iteracoes maxima {max_iter}, {vizinhanca} vizinhancas, q1,q2,q2 = {q1},{q2},{q3}, interpolacao = {inter}, fecho = {fecho}, pecas inisol = {env.max_pecas - int(round(len(env.lista)*0.0,0))}/{env.max_pecas}, rotacoes{rotacoes}\n")
