...
def GRASP_GCG(mIter, x,q1,q2,q3,rotacoes,pecas_inisol, instancia,tabela_nfps,base=None, altura=None, suavizar = True):
    print('\nGRASP GCG iniciado!')
    for i in range(mIter):
        print(f'Iteração {i} GRASP GCG.')
...
def ExSEARCH(ambiente, peca, grau_indice, draw, tabela_nfps):
    ...
    # nfp = interpolar_pontos_poligono(nfp,10)
