...
class envCSP(gym.Env):
    def __init__(self):
        ...
        self.action_space = spaces.MultiDiscrete([self.ambiente.max_pecas, self.ambiente.max_pecas,1])
...
if __name__ == '__main__':
    ...
    model = PPO(
        ...
        n_steps=240,               # Maior número de passos para capturar mais transições
