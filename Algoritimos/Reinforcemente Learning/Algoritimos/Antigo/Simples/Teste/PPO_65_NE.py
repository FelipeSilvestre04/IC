...
if __name__ == '__main__':
    ...
    model = PPO('MultiInputPolicy', envs, verbose=1, tensorboard_log=log_dir, n_steps=800, batch_size=400, n_epochs=10, gamma=0.9, policy_kwargs=policy_kwargs, learning_rate=3e-4, ent_coef=0.01)
