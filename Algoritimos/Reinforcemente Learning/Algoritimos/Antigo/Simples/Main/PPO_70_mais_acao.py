        ...
        if n == 0:
            if self.acao == 1:
                ...
                if self.fr:
                    ...
                    epsilon = 1e-2  # Defina uma tolerância pequena
                    if abs(maior - area_peca) < epsilon:
                        recompensa = min((areaPreenchida/self.fecho)**1, 1)
                        #recompensa = (areaPreenchida/self.area) - (1 - (areaPreenchida/self.fecho)**2)
                    else:
            ...
            if not self.done:
                ...
                self.recompensas.append(round(recompensa,2))
                ultimos_12_elementos = self.recompensas[-24:]
...
if __name__ == '__main__':
    ...
    # Use o callback durante o treinamento
