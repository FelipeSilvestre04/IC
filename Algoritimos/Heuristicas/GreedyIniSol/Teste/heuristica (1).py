...
def exact_fit(geraçao, matriz,t):
    ...
    i = 0
    i2 = 599
    while i < base and i2 >= 0:
        j = 0
        j2 = 399
        while j < altura and j2 >= 0:
            fim = time.time()
            ...
            #draw_piece2(x_transformado, y_transformado)
            if Gerador.Colocou:
                i, j = 0, 0
                i2, j2 = 599, 399
            else:
                on_click2(x_transformado, y2_transformado)
                #draw_piece2(x_transformado, y2_transformado)
                if Gerador.Colocou:
                    i, j = 0, 0
                    i2, j2 = 599, 399
                else:
                    on_click2(x2_transformado, y2_transformado)
                    #draw_piece2(x2_transformado, y2_transformado)
                    if Gerador.Colocou:
                        i, j = 0, 0
                        i2, j2 = 599, 399
                    else:
                        on_click2(x2_transformado, y_transformado)
                        #draw_piece2(x2_transformado, y_transformado)
                        if Gerador.Colocou:
                            i, j = 0, 0
                            i2, j2 = 599, 399
                        else:
