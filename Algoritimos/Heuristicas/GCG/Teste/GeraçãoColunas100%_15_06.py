...
def exact_fit(n,adicional,adicional2,m,draw, porcentagem,base,altura):
    ...
    Area.CordenadasProibidas[0][0]=Area.CordenadasProibidas[0][0] + adicional
    ...
    Area.CordenadasProibidas[3][0]=Area.CordenadasProibidas[3][0] + adicional
    ...
    while len(lista_poligonos) > 0:
        ...
        for l in range(0, len(lista_poligonos), 1):
            for grau in graus:
                ...
                while i < nova_base and not encontrou_posicao:
                    j = 0
                    ...
                    while j < altura:
                        ...
                        if cordenada_disponivel:
                            ...
                            if cordenada_disponivel:
                                ...
                                print(l, grau, (AreaPreenchida / area_fecho))
                                AreaPreenchida -= area_poligono
                                fecho.pop()
        ...
        if possiveis_posições:
            ...
            on_click2(possiveis_posições[index][2], possiveis_posições[index][3], possiveis_posições[index][4], fecho_turtle, dados_turtle, Bot, possiveis_posições[index][0], n, base, altura)
